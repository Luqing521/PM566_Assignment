...
#wind.sp
met_stations[, tempdif :=(abs(wind.sp-windsp50s)), ,by = STATE]
met_stations[recordid == tempdif, .(USAFID,wind.sp,windsp50, STATE)]


#atm.press
met_stations[, tempdif :=(abs(atm.press-atmp50s)), ,by = STATE]
...
temp_ave[, .temp := ifelse(temp >=25, High)]
temp_ave[, .temp := ifelse((temp <25)|(temp >=20), Mid)]
```
